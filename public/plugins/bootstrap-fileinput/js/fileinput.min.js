...
! function(e) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], e) : "object" == typeof module && module.exports ? module.exports = e(require("jquery")) : e(window.jQuery) }(function(e) {
    ...
    t = { FRAMES: ".kv-preview-thumb", SORT_CSS: "file-sortable", INIT_FLAG: "init-", OBJECT_PARAMS: '<param name="controller" value="true" />\n<param name="allowFullScreen" value="true" />\n<param name="allowScriptAccess" value="always" />\n<param name="autoPlay" value="false" />\n<param name="autoStart" value="false" />\n<param name="quality" value="high" />\n', DEFAULT_PREVIEW: '<div class="file-preview-other">\n<span class="{previewFileIconClass}">{previewFileIcon}</span>\n</div>', MODAL_ID: "kvFileinputModal", MODAL_EVENTS: ["show", "shown", "hide", "hidden", "loaded"], logMessages: { ajaxError: "{status}: {error}. Error Details: {text}.", badDroppedFiles: "Error scanning dropped files!", badExifParser: "Error loading the piexif.js library. {details}", badInputType: 'The input "type" must be set to "file" for initializing the "bootstrap-fileinput" plugin.', exifWarning: 'To avoid this warning, either set "autoOrientImage" to "false" OR ensure you have loaded the "piexif.js" library correctly on your page before the "fileinput.js" script.', invalidChunkSize: 'Invalid upload chunk size: "{chunkSize}". Resumable uploads are disabled.', invalidThumb: 'Invalid thumb frame with id: "{id}".', noResumableSupport: "The browser does not support resumable or chunk uploads.", noUploadUrl: 'The "uploadUrl" is not set. Ajax uploads and resumable uploads have been disabled.', retryStatus: "Retrying upload for chunk # {chunk} for {filename}... retry # {retry}.", chunkQueueError: "Could not push task to ajax pool for chunk index # {index}.", resumableMaxRetriesReached: "Maximum resumable ajax retries ({n}) reached.", resumableRetryError: "Could not retry the resumable request (try # {n})... aborting.", resumableAborting: "Aborting / cancelling the resumable request." }, objUrl: window.URL || window.webkitURL, now: function() { return (new Date).getTime() }, round: function(e) { return e = parseFloat(e), isNaN(e) ? 0 : Math.floor(Math.round(e)) }, getArray: function(e) { var t, i = [],
            ...
            a && e && !r ? a.requestFullscreen ? a.requestFullscreen() : a.msRequestFullscreen ? a.msRequestFullscreen() : a.mozRequestFullScreen ? a.mozRequestFullScreen() : a.webkitRequestFullscreen && a.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT) : r && (i.exitFullscreen ? i.exitFullscreen() : i.msExitFullscreen ? i.msExitFullscreen() : i.mozCancelFullScreen ? i.mozCancelFullScreen() : i.webkitExitFullscreen && i.webkitExitFullscreen()) }, moveArray: function(t, i, a, r) { var n = e.extend(!0, [], t); if (r && n.reverse(), a >= n.length)
                for (var o = a - n.length; o-- + 1;) n.push(void 0); return n.splice(a, 0, n.splice(i, 1)[0]), r && n.reverse(), n }, closeButton: function(e) { return e = e ? "close " + e : "close", '<button type="button" class="' + e + '" aria-label="Close">\n  <span aria-hidden="true">&times;</span>\n</button>' }, getRotation: function(e) { switch (e) {
                case 2:
        ...
        _initFileManager: function() { var i = this;
            i.uploadStartTime = t.now(), i.fileManager = { stack: {}, filesProcessed: [], errors: [], loadedImages: {}, totalImages: 0, totalFiles: null, totalSize: null, uploadedSize: 0, stats: {}, initStats: function(e) { var a = { started: t.now() };
                    ...
                    (t || a) && t !== a && (e.each(n, function(e, i) { e !== t && (r[e] = i), e === a && (r[t] = n[t]) }), i.fileManager.stack = r) }, list: function() { var t = []; return e.each(i.fileManager.stack, function(e, i) { i && i.file && t.push(i.file) }), t }, isPending: function(t) { return -1 === e.inArray(t, i.fileManager.filesProcessed) && i.fileManager.exists(t) }, isProcessed: function() { var t = !0,
                        a = i.fileManager; return e.each(a.stack, function(e) { a.isPending(e) && (t = !1) }), t }, clear: function() { var e = i.fileManager;
                    i.isDuplicateError = !1, i.isPersistentError = !1, e.totalFiles = null, e.totalSize = null, e.uploadedSize = 0, e.stack = {}, e.errors = [], e.filesProcessed = [], e.stats = {}, e.clearImages() }, clearImages: function() { i.fileManager.loadedImages = {}, i.fileManager.totalImages = 0 }, addImage: function(e, t) { i.fileManager.loadedImages[e] = t }, removeImage: function(e) { delete i.fileManager.loadedImages[e] }, getImageIdList: function() { return t.getObjectKeys(i.fileManager.loadedImages) }, getImageCount: function() { return i.fileManager.getImageIdList().length }, getId: function(e) { return i._getFileId(e) }, getIndex: function(e) { return i.fileManager.getIdList().indexOf(e) }, getThumb: function(t) { var a = null; return i._getThumbs().each(function() { var i = e(this);
                        i.attr("data-fileid") === t && (a = i) }), a }, getThumbIndex: function(e) { var t = e.attr("data-fileid"); return i.fileManager.getIndex(t) }, getIdList: function() { return t.getObjectKeys(i.fileManager.stack) }, getFile: function(e) { return i.fileManager.stack[e] || null }, getFileName: function(e, t) { var a = i.fileManager.getFile(e); return a ? t ? a.nameFmt || "" : a.name || "" : "" }, getFirstFile: function() { var e = i.fileManager.getIdList(),
        ...
        _resetPreview: function() { var i, a, r, n = this,
                o = n.showUploadedThumbs,
                l = !n.removeFromPreviewOnError,
                s = (o || l) && n.isDuplicateError;
            n.previewCache.count(!0) ? (i = n.previewCache.out(), s && (r = t.createElement("").insertAfter(n.$container), n.getFrames().each(function() { var t = e(this);
                (o && t.hasClass("file-preview-success") || l && t.hasClass("file-preview-error")) && r.append(t) })), n._setPreviewContent(i.content), n._setInitThumbAttr(), a = n.initialCaption ? n.initialCaption : i.caption, n._setCaption(a), s && (r.contents().appendTo(n.$preview), r.remove())) : (n._clearPreview(), n._initCaption()), n.showPreview && (n._initZoom(), n._initSortable()), n.isDuplicateError = !1 },
        ...
        _initSuccessThumbs: function() { var i = this;
            i.showPreview && i._getThumbs(t.FRAMES + ".file-preview-success").each(function() { var a = e(this),
        ...
        _previewFile: function(e, i, a, r, n) { if (this.showPreview) { var o, l = this,
                    ...
                    h = l._getThumbId(m); "html" === u && l.purifyHtml && window.DOMPurify && (g = window.DOMPurify.sanitize(g)), o = l._generatePreviewTemplate(u, g, s, d, h, m, !1, f), l._clearDefaultPreview(), l._addToPreview(p, o); var v = l._getFrame(h);
        ...
        _getResizedImage: function(i, a, r, n) { var o, l, s, d, c, u, p, f, g, m, h = this,
                ...
                E = a.ind,
                S = a.thumb,
                I = a.exifObj; if (c = function(e, t, i) { h.isAjaxUpload ? h._showFileError(e, t, i) : h._showError(e, t, i), h._setPreviewError(S) }, f = h.fileManager.getFile(i), g = { id: k, index: E, fileId: i }, m = [i, k, E], (!f || !x || C >= w && y >= b) && (x && f && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !x)) return void c(h.msgImageResizeError, g, "fileimageresizeerror");
        ...
        _createContainer: function() { var e = this,
                ...
                a = t.createElement(t.cspBuffer.stash(e._renderMain())); return t.cspBuffer.apply(a), a.insertBefore(e.$element).attr(i), e._initBrowse(a), e.theme && a.addClass("theme-" + e.theme), a },
        ...
        _resetFileStack: function() { var t = this,
            ...
            t._getThumbs().each(function() { var a = e(this),
                    ...
                    n = a.attr("id"); "-1" !== r && -1 !== r && (t.fileManager.getFile(a.attr("data-fileid")) ? a.attr({ "data-fileindex": "-1" }) : (a.attr({ "data-fileindex": i }), i++), t._getZoom(n).attr({ "data-fileindex": a.attr("data-fileindex") })) }) },
        ...
        readFiles: function(i) { this.reader = new FileReader; var a, r = this,
            ...
            r.fileManager.clearImages(), e.each(i, function(e, t) { var i = r.fileTypeSettings.image;
                ...
                r.lock(!0); var y, x, T, P, F, k, E, S, I, A, D, z, M, j, $ = i[w],
                    U = r._getFileId($),
                    R = c + "-" + U,
                    O = p.text,
                    B = p.image,
                    ...
                    K = !1,
                    G = 0,
                    Y = function() { var e = d.setTokens({ index: w + 1, files: u, percent: 50, name: N });
                        setTimeout(function() { l.html(e), r._updateFileDetails(u), a(w + 1) }, r.processDelay), r._raise("fileloaded", [$, R, U, w, n]) && r.isAjaxUpload && C.add($) }; if ($) { if (S = C.getId($), g > 0)
                        for (x = 0; g > x; x++) k = f[x], E = r.msgFileTypes[k] || k, V += 0 === x ? E : ", " + E; if (N === !1) return void a(w + 1); if (0 === N.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName($), "[unknown]")), void v(T, $, R, w, S); if (t.isEmpty(m) || (H = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = Z.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame(R, !0).length) { var J = { id: R, index: w, fileId: S, file: $, files: i }; return T = r.msgDuplicateFile.setTokens({ name: N, size: y }), void(r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [$, S, N, y, R, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, J), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u))) } if (r.maxFileSize > 0 && Z > r.maxFileSize) return T = r.msgSizeTooLarge.setTokens({ name: N, size: y, maxSize: r.maxFileSize }), void v(T, $, R, w, S); if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize)) return T = r.msgSizeTooSmall.setTokens({ name: N, size: y, minSize: r.minFileSize }), void v(T, $, R, w, S); if (!t.isEmpty(f) && t.isArray(f)) { for (x = 0; x < f.length; x += 1) P = f[x], A = p[P], q += A && "function" == typeof A && A($.type, t.getFileName($)) ? 1 : 0; if (0 === q) return T = r.msgInvalidFileType.setTokens({ name: N, types: V }), void v(T, $, R, w, S) } if (0 === q && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(H) && (F = t.compare(N, H), q += t.isEmpty(F) ? 0 : F.length, 0 === q)) return T = r.msgInvalidFileExtension.setTokens({ name: N, extensions: h }), void v(T, $, R, w, S); if (!r._canPreview($)) return I = r.isAjaxUpload && r._raise("filebeforeload", [$, w, n]), r.isAjaxUpload && I && C.add($), r.showPreview && I && (o.addClass("file-thumb-loading"), r._previewDefault($), r._initFileActions()), void setTimeout(function() { I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [$, R, U, w]) }, 10);
                    D = O($.type, N), z = L($.type, N), M = B($.type, N), l.html(s.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), n.onerror = function(e) { r._errorHandler(e, N) }, n.onload = function(i) { var a, s, d, c, u, f, g = [],
                            m = function(e) { var t = new FileReader;
                                t.onerror = function(e) { r._errorHandler(e, N) }, t.onload = function(e) { return r.isAjaxUpload && !r._raise("filebeforeload", [$, w, n]) ? (K = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, $, e, W, s), r._initFileActions(), void Y()) }, e ? t.readAsText($, r.textEncoding) : t.readAsDataURL($) }; if (s = { name: N, type: $.type }, e.each(p, function(e, t) { "object" !== e && "other" !== e && "function" == typeof t && t($.type, N) && G++ }), 0 === G) { for (d = new Uint8Array(i.target.result), x = 0; x < d.length; x++) c = d[x].toString(16), g.push(c); if (a = g.join("").toLowerCase().substring(0, 8), f = t.getMimeType(a, "", ""), t.isEmpty(f) && (u = t.arrayBuffer2String(n.result), f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, $.type)), s = { name: N, type: f }, D = O(f, ""), z = L(f, ""), M = B(f, ""), j = D || z, j || M) return void m(j) } return r.isAjaxUpload && !r._raise("filebeforeload", [$, w, n]) ? (K = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, $, i, W, s), r._initFileActions(), void Y()) }, n.onprogress = function(e) { if (e.lengthComputable) { var t = e.loaded / e.total * 100,
                                i = Math.ceil(t);
                            T = d.setTokens({ index: w + 1, files: u, percent: i, name: N }), setTimeout(function() { K || l.html(T) }, r.processDelay) } }, D || z ? n.readAsText($, r.textEncoding) : M ? n.readAsDataURL($) : n.readAsArrayBuffer($) } }, a(0), r._updateFileDetails(u, !0) },
        ...
        resume: function() { var e = this,
                t = !1,
                i = e.resumableManager; return e.enableResumableUpload ? (e.paused ? e._toggleResumableProgress(e.progressPauseTemplate, e.msgUploadResume) : t = !0, e.paused = !1, t && e._toggleResumableProgress(e.progressInfoTemplate, e.msgUploadBegin), setTimeout(function() { i.upload() }, e.processDelay), e.$element) : e.$element },
        pause: function() { var t, i = this,
                ...
                a.removeClass("file-uploading"), s.attr("title") === l.indicatorLoadingTitle && (i._setThumbStatus(a, "Paused"), t = n.setTokens({ pendingTime: i.msgPaused, uploadSpeed: "" }), i.paused = !0, i._setProgress(o, a.find(".file-thumb-progress"), o + "%", t)), i.fileManager.getFile(r) || a.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled") }), i._setProgress(101, i.$progress, i.msgPaused), i.$element },
        ...
        upload: function() { var i, a, r = this,
                n = r.fileManager,
                o = n.count(),
                l = !e.isEmptyObject(r._getExtraData()); if (r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o)) return r.lastProgress = 0, r._resetUpload(), 0 !== o || l ? (r.cancelling = !1, r._showProgress(), r.lock(), 0 === o && l ? (r._setProgress(2), void r._uploadExtraOnly()) : r.enableResumableUpload ? r.resume() : ((r.uploadAsync || r.enableResumableUpload) && (a = r._getOutData(null), r._raise("filebatchpreupload", [a]), r.fileBatchCompleted = !1, r.uploadCache = [], e.each(r.getFileStack(), function(e) { var t = r._getThumbId(e);
